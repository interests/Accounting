...
/**Класс для определения заданной точности при вводе сумм
 * исходники взял с https://habrahabr.ru/post/264493/
...
public class NumberEditText extends EditText{
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            digsBeforeDot = a.getInt(R.styleable.NumberEditText_digits_before_dot, DIGITS_BEFORE_DOT);
            digsAfterDot = a.getInt(R.styleable.NumberEditText_digits_after_dot, DIGITS_AFTER_DOT);
